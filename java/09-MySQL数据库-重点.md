...
### [mysql哪些查询情况不走索引](https://blog.csdn.net/Dxy1239310216/article/details/121679668)
上题类似的问法。
...
![分片](09-MySQL数据库面试题（2020最新版）-重点.assets/分片.jpg)
...
## MySQL的复制原理以及流程-必会
  ...
  ![复制过程](09-MySQL数据库面试题（2020最新版）-重点.assets/复制过程.jpg)
  ...
  （另外保持主从数据库时间一致）
  ![主从复制具体步骤](09-MySQL数据库面试题（2020最新版）-重点.assets/主从复制具体步骤.png)
